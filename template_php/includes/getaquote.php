...
if( $_SERVER['REQUEST_METHOD'] == 'POST' ) {
    if( $_POST['form_name'] != '' AND $_POST['form_email'] != '' ) {
        ...
        $subject = isset($subject) ? $subject : 'New Message | Get Your Project Started Form';
        ...
        if( $botcheck == '' ) {
            ...
            $service = isset($service) ? "Date: $service<br><br>" : '';
            $message = isset($message) ? "Message: $message<br><br>" : '';

            $referrer = $_SERVER['HTTP_REFERER'] ? '<br><br><br>This Form was submitted from: ' . $_SERVER['HTTP_REFERER'] : '';

            $body = "$name $email $phone $date $service $message $referrer";
